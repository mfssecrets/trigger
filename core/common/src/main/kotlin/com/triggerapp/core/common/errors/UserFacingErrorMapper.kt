package com.triggerapp.core.common.errors
...
private object UserFacingErrorMapperTokens {
    const val LOG_TAG = "TriggerAppError"
...
fun Throwable.userFacingMessage(
    offlineFallback: String = TriggerStrings.Errors.OFFLINE_GENERIC,
    genericFallback: String = TriggerStrings.Errors.GENERIC,
): String {
