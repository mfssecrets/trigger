...
internal fun ProfilePhotoSourceBottomSheet(
    ...
    ModalBottomSheet(
        ...
        containerColor = TriggerSurfaceMuted,
        ...
        Column(Modifier.fillMaxWidth().padding(bottom = 8.dp)) {
            Text(
                text = TriggerStrings.Ui.PROFILE_PHOTO,
            ...
            SheetRow(
                icon = { Icon(Icons.Outlined.PhotoLibrary, contentDescription = null, tint = TriggerAccent) },
                label = TriggerStrings.Ui.CHOOSE_FROM_GALLERY,
                onClick = {
                    onChooseGallery()
                    onDismiss()
                },
            ...
            SheetRow(
                icon = { Icon(Icons.Outlined.PhotoCamera, contentDescription = null, tint = TriggerAccent) },
                label = TriggerStrings.Ui.TAKE_PHOTO,
                onClick = {
                    onTakePhoto()
                    onDismiss()
                },
            ...
            TextButton(
                ...
                Text(TriggerStrings.Ui.CANCEL, color = Color.White.copy(alpha = 0.85f))
            }
        }
    }
}
